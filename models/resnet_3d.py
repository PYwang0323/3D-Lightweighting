...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.layer1 = self._make_layer3d(block, 1, num_blocks[0], stride=1)
        self.layer2 = self._make_layer3d(block, 2, num_blocks[1], stride=2)
        self.layer3 = self._make_layer3d(block, 4, num_blocks[2], stride=2)
        self.layer4 = self._make_layer3d(block, 8, num_blocks[3], stride=2)
...
def resnet18_3d():
    return ResNet(BasicBlock3d, [2,2,2,2])

def resnet34_3d():
    return ResNet(BasicBlock3d, [3,4,6,3])

def resnet50_3d(num_classes):
    return ResNet(Bottleneck3d, [3,4,6,3], num_classes)

def resnet101_3d():
    return ResNet(Bottleneck3d, [3,4,23,3])

def resnet152_3d():
    return ResNet(Bottleneck3d, [3,8,36,3])
